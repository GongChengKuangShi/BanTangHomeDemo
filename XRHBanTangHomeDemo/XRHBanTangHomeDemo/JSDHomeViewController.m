...
- (UIScrollView *)bottomScrollView {
    ...
    if (!_bottomScrollView) {
        ...
        NSArray *color = @[[UIColor redColor],[UIColor blueColor],[UIColor grayColor],[UIColor greenColor],[UIColor purpleColor],[UIColor orangeColor],[UIColor whiteColor],[UIColor redColor],[UIColor blueColor],[UIColor grayColor],[UIColor greenColor]];
        ...
        for (int i = 0; i < CATEGORY.count; i++) {
            ...
            jsdTableViewController.view.backgroundColor = [color objectAtIndex:i];
        ...
        self.currentTableView = [self.tableViews objectAtIndex:0];
...
- (void)changeSelectedItem:(UIButton *)currentButton {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        if (index == 0) {
            ...
            self.currentSelectedItemImageView.frame = CGRectMake(CGRectGetMinX(currentButton.frame), self.segmentScrollView.frame.size.height, currentButton.frame.size.width, 2);
        }
